...
import { Wallet, ArrowLeft, CheckCircle2, Mail, Sun, Moon } from 'lucide-react';
...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      setIsSubmitted(true);
      showToast('Tautan atur ulang kata sandi telah dikirim.', 'success');
    }, 400);
  };
              ...
              <div className="text-center space-y-4 py-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 max-w-xs mx-auto">
                    Instruksi atur ulang kata sandi telah dikirim ke <strong>{email}</strong>.
                  </p>
                </div>
              ...
              <>
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                    Masukkan email terdaftar Anda untuk menerima tautan pemulihan sandi.
                  </p>
                </div>
